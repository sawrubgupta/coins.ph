...
module.exports = function () {
    ...
    _createClass(Coins, [{
        key: "createBuyorder",
        value: function createBuyorder(data, cb) {
        ...
        value: function markBuyorderPaid(data, cb) {
            return this._request({
        ...
        key: "buyorder",
        value: function buyorder(params, cb) {
            return this._request({
        ...
        key: "createSellorder",
        value: function createSellorder(data, cb) {
            return this._request({
                url: "sellorder",
                method: "POST",
                data: data,
        ...
        key: "validateField",
        value: function validateField(data, cb) {
            return this._request({
                url: "validate-field",
                method: "POST",
                params: {},
        ...
        key: "sellorder",
        value: function sellorder(params, cb) {
            return this._request({
        ...
        value: function transactionHistory(cb) {
            return this._request({
                url: "buyorder",
                params: {},
                data: "orders",
        ...
        key: "payinOutlets",
        value: function payinOutlets(params, cb) {
            return this._request({
                url: "payin-outlets",
                method: "GET",
                params: params
        ...
        key: "payinOutletFees",
        value: function payinOutletFees(params, cb) {
            return this._request({
        ...
        value: function payinOutletCategories(params, cb) {
            return this._request({
        ...
        key: "payoutOutlets",
        value: function payoutOutlets(params, cb) {
            return this._request({
                url: "payout-outlets",
                method: "GET",
                params: params
        ...
        value: function payoutOutletCategories(params, cb) {
            return this._request({
        ...
        value: function payoutOutletFees(params, cb) {
            return this._request({
        ...
        value: function createPaymentRequest(data, cb) {
            return this._request({
        ...
        key: "paymentRequests",
        value: function paymentRequests(params, cb) {
            return this._request({
        ...
        value: function createTransferRequest(data, cb) {
            return this._request({
                url: "transfers",
                method: "POST",
                data: data,
        ...
        key: "transfers",
        value: function transfers(params, cb) {
            return this._request({
        ...
        key: "cryptoAccounts",
        value: function cryptoAccounts(params, cb) {
            return this._request({
                url: "crypto-accounts",
                params: params,
                version: "api/v3"
        ...
        key: "convertFunds",
        value: function convertFunds(data, cb) {
            return this._request({
        ...
        key: "cryptoExchanges",
        value: function cryptoExchanges(params, cb) {
            return this._request({
        ...
        key: "cryptoRoutes",
        value: function cryptoRoutes(cb) {
            return this._request({
                url: "crypto-routes",
                version: "api/v3",
                responseField: " "
        ...
        key: "cryptoPayments",
        value: function cryptoPayments(params, cb) {
            return this._request({
        ...
        value: function _signRequest(url, body) {
            var nonce = this._getNonce().toString(),
                message = null;
        ...
        key: "_request",
        value: function _request(options, cb) {
