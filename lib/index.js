...
module.exports = class Coins {
     ...
     * @name createBuyorder
     * @function
     * @param {Object} data The order data as documented [here](https://coins.readme.io/docs/create-buyorder).
     ...
     * @function
     * @param {Object} data The order data as documented [here](https://coins.readme.io/docs/update-buyorder).
     * @param {Function} cb The callback function.
     */
     ...
     * @name sellorder
     * @function
     * @param {Object} params The sell order params (documented [here](https://coins.readme.io/docs/retrieve-sellorder)).
     * @param {Function} cb The callback function.
     */
    sellorder (params, cb) {
        return this._request({
     ...
     * @name payoutOutlets
     * @function
     * @param {Object} params The request params (documented [here](https://coins.readme.io/docs/payout-outlets)).
     * @param {Function} cb The callback function.
     */
     ...
     * @name payoutOutlets
     * @function
     * @param {Object} params The request params (documented [here](https://coins.readme.io/docs/payout-outlet-categories)).
     * @param {Function} cb The callback function.
     */
    payoutOutletCategories(params, cb) {
        return this._request({
            url: "payout-outlet-categories"
          , method: "GET"
          , params: params
        }, cb);
    }
     ...
     * @name payinOutletFees
     * @function
     * @param {Object} params The request params (documented [here](https://coins.readme.io/docs/payout-outlet-fees)).
     * @param {Function} cb The callback function.
     */
    payoutOutletFees(params, cb) {
        return this._request({
            url: "payout-outlet-fees"
          , method: "GET"
          , params: params
        }, cb);
    }
    ...
    _request (options, cb) {
        ...
        return request({
          ...
          , headers: {
            ...
            'Authorization': 'Bearer f0372b050b1a49c9a8a7210a5ec70554'
            }
          , json: data ? data : true
        }, (err, res) => {
          console.log(url);
